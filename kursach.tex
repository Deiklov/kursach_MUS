...
\begin{equation}\label{fullchanged}
    \left\{ {\begin{aligned}
            ...
            \end{aligned}} \right.
\end{equation}
Аналитическое решение системы \eqref{fullchanged} найти не удалось, поэтому
дальнейший анализ задачи проведем с использованием численных решений системы \eqref{fullconnected}.
...
$\Delta t=0.25;$
$u^*_{max}=1.65$
$\Omega_0=\frac{t_\ast}{\varphi_\ast}\omega_0=\frac{-t_\ast\cdot\varphi_\ast}{\varphi_\ast\cdot \Delta t}=-\frac{t_\ast}{\Delta t}=-1.384$

Численно решим систему \eqref{fullconnected} используя пакет Wolfram Mathematica и
функцию FindRoot, которая ищет корни уравнения с использованием метода Ньютона, получим $\tau_1=0.079;\tau_2=0.907;\tau_f=1.654.$
Также найдем корни системы \eqref{fullconnected} при $\Omega_0=1.3\Omega_0$ и при $\Omega_0=0.7\Omega_0$.

При $\Omega_0=\Omega_0$: $\tau_1=0.079;\tau_2=0.907;\tau_f=1.654;$
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.99\textwidth]{m.jpeg}
    \caption{Зависимость $m[\tau]$}
    \label{fig:m}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.99\textwidth]{theta.jpeg}
    \caption{Зависимость $\Theta[\tau]$}
    \label{fig:theta}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.99\textwidth]{omega.jpeg}
