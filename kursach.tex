...
\begin{equation}\label{findtau}
    \footnotesize\left\{ {\begin{aligned}
                 ...
                 & \frac{u}{2}(e^{-\tau_f+\tau_2}-e^{\tau_f-\tau_2})-u_*(\tau_2-\tau_f) =\frac{u_*+\Omega_0}{2}(e^{\tau_1}-e^{-\tau_1})+\frac{1}{2}(e^{\tau_1}+e^{-\tau_1})-u_*(2\tau_1-e^{\tau_1-\tau_2}+e^{-\tau_1+\tau_2}-\tau_2), \hfill \\
                 & \frac{u}{2}(e^{-\tau_f+\tau_2}+e^{\tau_f-\tau_2})-u_*=\frac{1}{2}(e^{\tau_1}-e^{-\tau_1})+\frac{u_*+\Omega_0}{2}(e^{\tau_1}+e^{-\tau_1})+u_*(1-e^{\tau_1-\tau_2}-e^{-\tau_1+\tau_2}) . \hfill                             \\
            \end{aligned}} \right.
\end{equation}
